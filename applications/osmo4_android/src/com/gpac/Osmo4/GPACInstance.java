/**
 * $URL: http://svn.code.sf.net/p/gpac/code/trunk/gpac/applications/osmo4_android/src/com/gpac/Osmo4/GPACInstance.java $
 *
 * $LastChangedBy: jeanlf $ - $LastChangedDate: 2013-03-14 17:54:01 +0100 (jeu., 14 mars 2013) $
 */
    ...
    synchronized static Map<String, Throwable> loadAllLibraries(GpacConfig config) {
        ...
        if (!exceptions.isEmpty()) {
            try {
                ...
                out.println("$Revision: 4366 $"); //$NON-NLS-1$
